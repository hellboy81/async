...
*На решении каких проблем сосредоточена ваша библиотека? То есть, она сосредоточена главным образом на удалении шаблонного кода, уходе от ручной обработки асинхронного ввода/вывода, или же она также обеспечивает дирижирование или другой функционал (например, чтобы помочь с одновременной обработкой нескольких I/O-вызовов с ожиданием результатов их выполнения, и так далее).*
